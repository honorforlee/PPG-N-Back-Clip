...
from ppg.params import TOTAL_SESSION_NUM, REST_DURATION, BLOCK_DURATION, PPG_SAMPLE_RATE
from ppg.params import BIOPAC_HEADER_LINES, BIOPAC_MSEC_PER_SAMPLE_LINE_NUM, BIOPAC_ECG_CHANNEL, BIOPAC_SKIN_CONDUCTANCE_CHANNEL
